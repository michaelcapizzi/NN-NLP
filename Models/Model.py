    ...
    def train(self, fPath, num_lines, neg_sample, save_data=False, f_vec=None, f_lab=None, lemmatize=True):
        ...
        for e in range(self.num_epochs):
            ...
            if save_data:
                ...
                f_vector = open(f_vec + "-lines=" + str(num_lines) + "-window=" + str(self.window_size) + "-negSample=" + str(neg_sample) + ".csv", "wb")
                f_label = open(f_lab + "-lines=" + str(num_lines) + "-window=" + str(self.window_size) + "-negSample=" + str(neg_sample) + ".csv", "wb")
